...
class VideoIndexerBQ:
    ...
    def setup_bigquery_schema(self):
        ...
        videos_schema = [
            ...
            bigquery.SchemaField("video_gcs_uri", "STRING", mode="REQUIRED",
            ...
            bigquery.SchemaField("json_gcs_uri", "STRING", mode="REQUIRED",
            ...
            bigquery.SchemaField("total_segments", "INTEGER", mode="NULLABLE",
                               description="Number of segments"),
            bigquery.SchemaField("total_speakers", "INTEGER", mode="NULLABLE",
                               description="Number of unique speakers"),
            bigquery.SchemaField("has_diarization", "BOOLEAN", mode="NULLABLE",
                               description="Whether speaker diarization was used"),
            bigquery.SchemaField("has_ocr", "BOOLEAN", mode="NULLABLE",
        ...
        segments_schema = [
            ...
            bigquery.SchemaField("start_time_seconds", "FLOAT64", mode="REQUIRED",
                               description="Segment start time in seconds (precise)"),
            bigquery.SchemaField("end_time_seconds", "FLOAT64", mode="REQUIRED",
                               description="Segment end time in seconds (precise)"),
            bigquery.SchemaField("start_time_int", "INTEGER", mode="REQUIRED",
            ...
            bigquery.SchemaField("slide_text", "STRING", mode="NULLABLE",
                               description="Text extracted from slides via OCR"),
            bigquery.SchemaField("combined_text", "STRING", mode="NULLABLE",
            ...
            # Speaker information
            bigquery.SchemaField("speaker_tag", "INTEGER", mode="NULLABLE",
    ...
    def index_video_json(self, json_uri: str, batch_size: int = 500):
        ...
        video_gcs_uri = json_uri.replace("/processed_json/", "/raw/").replace(".json", "")
        ...
        if errors:
            ...
            print(f"✅ Video metadata inserted")
    ...
    def _extract_keywords(self, text: str, max_keywords: int = 20) -> List[str]:
        ...
        stop_words = {
            ...
            'now', 'also', 'well', 'even', 'back', 'still', 'way', 'our', 'their',
            'them', 'about', 'out', 'up', 'down', 'over', 'under', 'after', 'before',
            'into', 'through', 'during', 'against', 'between', 'above', 'below',
            'any', 'because', 'being', 'doing', 'having', 'get', 'got', 'getting'
        }
    ...
    def _identify_topics(self, text: str) -> List[str]:
        ...
        topic_patterns = {
            ...
            "agent_development": ["agent", "adk", "agent development", "build agent", "create agent"],
            "machine_learning": ["machine learning", "ml", "neural", "model", "training", "inference"],
            "ai": ["artificial intelligence", "ai", "llm", "large language", "gpt", "gemini"],
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Index processed videos to BigQuery for ADK")
    parser.add_argument("--project_id", required=True, help="GCP Project ID")
    parser.add_argument("--json_uri", help="GCS URI of processed JSON (gs://bucket/path/file.json)")
    parser.add_argument("--json_folder", help="GCS folder with multiple JSONs (gs://bucket/processed_json/)")
    parser.add_argument("--setup_tables", action="store_true", help="Setup BigQuery tables and views")
